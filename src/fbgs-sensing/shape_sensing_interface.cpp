...
bool ShapeSensingInterface::getData(boost::asio::streambuf &t_data)
{
    try
    {
...
ShapeSensingInterface::Sample ShapeSensingInterface::processData(boost::asio::streambuf &t_data)
{
    Sample sample;

    std::string data_string;
    std::istream is(&t_data);
